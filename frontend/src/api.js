...
export const api = {
  ...
  getPeer: (node, asn) => request(`/api/v1/nodes/${encodeURIComponent(node)}/peers/${encodeURIComponent(asn)}`),
  adminPeers: (node) => request(`/api/v1/admin/nodes/${encodeURIComponent(node)}/peers`),
  adminPeer: (node, asn) => request(`/api/v1/admin/nodes/${encodeURIComponent(node)}/peers/${encodeURIComponent(asn)}`),
